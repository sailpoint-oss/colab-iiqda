 ...
 * file <code>IPFStrings.properties</code> in the sailpoint.sailpoint.iiqda
 * package, and allows retrieval of keyed strings from that bundle. 
 *
 */
public class IPFStrings
{
	private static final String BUNDLE_NAME = "sailpoint.iiqda.i18n.IPFResources";
